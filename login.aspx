...
<head>
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
                ...
                Request.QueryString["logoff"].ToLowerInvariant() == "true")
            {
                ...
                ErrorMessage.Text = "U bent uitgelogd";
    ...
    <style>
       ...
       #login h1
        {
            background: url(http://www.os-websolutions.nl/logo/bg-login.jpg);
            color: #000;
            font-size: 14px;
            padding: 18px 23px;
            margin: 0 0 1.5em 0;
...
<body>
    ...
    <h1>
       Inloggen met uw account!</h1>
    <p class="register">
        <a href="Login.aspx?logoff=true">Uitloggen</a>
    </p>
    <div>
        <label for="login_username">
            Gebruikersnaam:</label>
        <input type="text" name="username" id="login_username" class="field required" title="Gelieve uw gebruikersnaam invoeren" />
    </div>
    <div>
        <label for="login_password">
            Wachtwoord:</label>
        <input type="password" name="password" id="login_password" class="field required"
            title="Wachtwoord is vereist" />
    </div>
    <div class="submit">
        <asp:Button Text="Inloggen" runat="server" OnClick="LogIn_Clicked" />
        <!--
		<label>
    ...
    <p class="back">
        <asp:Literal Text="Inloggen is mislukt" runat="server" Visible="false" ID="ErrorMessage" />    
    </p>
    </form>
</body>
</html>
